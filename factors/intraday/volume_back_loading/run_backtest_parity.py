#!/usr/bin/env python3
"""Production, signal and backtest parity for volume_back_loading."""
...
FACTOR = "volume_back_loading"
FLAG = "INTRADAY_VOLUME_BACK_USE_DDB"
PARITY_ROOT = ROOT / "result" / "intraday" / "_parity_volume_back_loading"
...
def trace_production_path() -> None:
    ...
    print(
        ...
        "compute_volume_back_loading → ddb_version",
        flush=True,
    )
...
def run_signal_parity(start: str, end: str) -> Dict[str, Any]:
    from factors.intraday.volume_back_loading.test_compare import (
        assert_consistency,
    )
...
def run_backtest_parity(
    ...
    """Reuse the already validated Level-3 harness with factor-specific globals."""
