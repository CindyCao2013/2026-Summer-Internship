#!/usr/bin/env python3
"""Production, signal and backtest parity for late_session_strength."""
...
FACTOR = "late_session_strength"
FLAG = "INTRADAY_LATE_SESSION_STRENGTH_USE_DDB"
PARITY_ROOT = ROOT / "result" / "intraday" / "_parity_late_session_strength"
...
def trace_production_path() -> None:
    ...
    print(
        ...
        "compute_late_session_strength → ddb_version",
        flush=True,
    )
...
def run_signal_parity(start: str, end: str) -> Dict[str, Any]:
    from factors.intraday.late_session_strength.test_compare import (
        assert_consistency,
    )
