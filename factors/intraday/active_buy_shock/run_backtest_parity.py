#!/usr/bin/env python3
"""Signal and unchanged-backtest parity runner for active_buy_shock."""
...
FACTOR = "active_buy_shock"
FLAG = "INTRADAY_ACTIVE_BUY_SHOCK_USE_DDB"
PARITY_ROOT = ROOT / "result" / "intraday" / "_parity_active_buy_shock"
...
def run_signal_parity(start: str, end: str) -> Dict[str, Any]:
    from factors.intraday.active_buy_shock.test_compare import assert_consistency
...
def run_backtest_parity(
    ...
    """Reuse the established unchanged-evaluation parity harness."""
