#!/usr/bin/env python3
"""Production-route, signal and full-backtest parity for bartime_ofi."""
...
FACTOR = "bartime_ofi"
FLAG = "INTRADAY_BARTIME_OFI_USE_DDB"
PARITY_ROOT = ROOT / "result" / "intraday" / "_parity_bartime_ofi"
...
def trace_production_path() -> None:
    ...
    print(
        ...
        "compute_bartime_ofi → discovery_v1.ddb_version",
        flush=True,
    )
...
def run_signal_parity(start: str, end: str) -> Dict[str, Any]:
    from factors.intraday.bartime_ofi.test_compare import assert_consistency
